...
\begin{figure}[h] \centering \includegraphics[width=0.50\linewidth]{images/frequenctOfPageFault.png} \caption{frequenctOfPageFault.png} \label{fig:10.23} \end{figure}
