...
\begin{figure}[h] \centering \includegraphics[width=0.50\linewidth]{images/traduzione_indirizzi_paginazione2Livelli.png} \caption{traduzione_indirizzi_paginazione2Livelli.png} \label{fig:9.16} \end{figure}
...
\begin{figure}[h] \centering \includegraphics[width=0.50\linewidth]{images/ex_paginazione2Livelli.png} \caption{ex_paginazione2Livelli.png} \label{fig:9.17} \end{figure}
