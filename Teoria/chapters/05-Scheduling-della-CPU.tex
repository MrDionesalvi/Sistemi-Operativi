...
\qs{}{Cosa succede se ora la {CPU} viene data a un altro processo utente che tenta di usare lo stesso dispositivo di {\textbf{I/O}} che il processo precedente stava utilizzando? Quale semplice soluzione può essere adottata in tali casi?}
